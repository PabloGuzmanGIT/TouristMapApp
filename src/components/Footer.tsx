...
export default function Footer() {
    return (
        <footer className="bg-footer text-neutral-300 py-12 px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-7xl">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-8">
                    <div>
                        <div className="flex items-center gap-2 mb-4">
                            <MapPin className="w-6 h-6 text-accent" />
                            <span className="text-xl font-bold text-white font-heading">Explora Perú</span>
                        </div>
                        <p className="text-sm">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            ...
                            <li><Link href="/add-place" className="hover:text-accent transition-colors">Agregar Lugar</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex gap-4">
                            <a href="#" className="w-10 h-10 rounded-full bg-white/10 hover:bg-accent/30 flex items-center justify-center transition-colors">
                                FB
                            </a>
                            <a href="#" className="w-10 h-10 rounded-full bg-white/10 hover:bg-accent/30 flex items-center justify-center transition-colors">
                                IG
